...
int main(void) {
    ...
    //draw square
    unsigned int fragmentUniforColorLocation = glGetUniformLocation(shaderProgram, "anim_time");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(fragmentUniforColorLocation, (sin(glfwGetTime() / 2.0f) + 0.5f));
